...
/// <summary>
/// MotionClockMove = moving platformun kendi saati.
/// - Server-authoritative: Start/Pause/Resume/Reset sadece server yazar; NetVar'larla client'lara yayılır.
/// - Driver script (MovingPlatform) her kare EffectiveTime (ET) okur ve hareketi LOKAL uygular.
...
[AddComponentMenu("Netcode/MotionClock (Move)")]
public class MotionClockMove : NetworkBehaviour
{
    // -------- Inspector --------
    [Header("Startup")]
